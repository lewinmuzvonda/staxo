...
@section('content')
    ...
    <section class="container pt-5">
        <div class="container p-5 border-2 rounded-3 border-primary">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <p id="processtext" class="fw-bold text-primary"></p>
                <form id="pay" action="{{ route('pay.post') }}" method="post">
                    ...
                    <button class="btn btn-primary mt-4" onClick="hold()" id="card-button">
                        Process Payment
                    </button>
                </form>
    ...
    <script>
        ...
        const hold = async () => {
            document.getElementById('processtext').innerHTML = 'Please wait...PROCESSING';
